      ...
      <div className="ff-container">
        ...
        <div className="ff-container-videopage">
          <div className="ff-container-videoplayer">
            ...
            <div className="ff-videoplayer-text">
              <div className="ff-container-options">
                <div>
                  <span className="h6">Views</span>|
                  <span className="h6">Date</span>
                </div>
                <div className="ff-videoplayer-icon-wrap">
                  <div className="ff-videoplayer-icon-chip  btn-warning btn-warning-hover ff-btn-secondary">
              ...
              <div className="ff-videoplayer-desc">
                <div className="ff-videoplayer-author-wrap">
                  <img
